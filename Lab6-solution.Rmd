...
yhe row it is about the resturant adress (more information about it)
column (adress , city , stat ,zip , longitude , latitude )
...
#head(laquinta)
```
\textcolor{red}{This dataset has 909 rows and 6 columns. Each row 
represents location information about laquinta's hotel.}

the row it is about the hotel adress (more information about it)
column (adress , city , stat ,zip , longitude , latitude )
...
Joining La Quinta's and states=AK
